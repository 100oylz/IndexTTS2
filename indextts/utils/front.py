...
class TextTokenizer:
    ...
    def split_segments_by_token(
        ...
        for segment in segments:
            ...
            elif len(merged_segments[-1]) + len(
                    segment) <= max_text_tokens_per_segment and total_token > quick_streaming_tokens:
    ...
    def split_segments(self, tokenized: List[str], max_text_tokens_per_segment=120, quick_streaming_tokens=0) -> List[
        List[str]]:
